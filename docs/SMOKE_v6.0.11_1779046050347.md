...
| | 04 POST /api/v4/receipts/export (v6.0.11) | PASS | count=10, file=C:\Users\a\AppData\Roaming\com.atomeons.orangebox.command\exports\receipts-1779046049170.md |
...
| | 19 GET /api/v4/trilane/votes (v6.0.11) | PASS | items=4 |
| | 20 POST /api/v4/trilane/vote (v6.0.11) | PASS | id=5dcfd355-ff31-4997-9dd5-96f104ee19c9 |
...
| | 35 Receipts emit cycle (POST then GET) | PASS | emitted ec66b7dd-b353-43c7-9d2f-5583432d4ce9, list contains: true |
| | 36 Receipt schema (source, ts, id, title) | PASS | id=true source=true ts=true title=true |
| | 37 Sources filter works | PASS | 8 items, all smoke=true |
...
| | 47 Receipts export markdown bundle exists on disk | PASS | 6137b at C:\Users\a\AppData\Roaming\com.atomeons.orangebox.command\exports\receipts-1779046050324.md |
