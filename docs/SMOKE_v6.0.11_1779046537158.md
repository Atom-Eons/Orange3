...
**Date:** 2026-05-17T19:35:37.157Z
**Results:** 50 pass · 0 fail · 0 skip / 50
...
| | 04 POST /api/v4/receipts/export (v6.0.11) | PASS | count=10, file=C:\Users\a\AppData\Roaming\com.atomeons.orangebox.command\exports\receipts-1779046535836.md |
...
| | 19 GET /api/v4/trilane/votes (v6.0.11) | PASS | items=5 |
| | 20 POST /api/v4/trilane/vote (v6.0.11) | PASS | id=e42a4707-3a47-496f-8d71-717833b9ecbb |
| | 21 GET /api/v4/deps/status | PASS | status=200 |
| | 22 POST /api/v4/composer/scaffold (empty files) | PASS | status=400 |
...
| | 32 AE Alpha anchors file exists | PASS | C:\Users\a\AppData\Roaming\com.atomeons.orangebox.command\ae-alpha-news.json |
...
| | 35 Receipts emit cycle (POST then GET) | PASS | emitted d3965237-4089-4f33-8a3b-671cdd2d4c89, list contains: true |
| | 36 Receipt schema (source, ts, id, title) | PASS | id=true source=true ts=true title=true |
| | 37 Sources filter works | PASS | 10 items, all smoke=true |
...
| | 47 Receipts export markdown bundle exists on disk | PASS | 6137b at C:\Users\a\AppData\Roaming\com.atomeons.orangebox.command\exports\receipts-1779046537130.md |
