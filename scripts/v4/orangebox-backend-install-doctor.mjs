...
async function main() {
  ...
  const backendScripts = {
    ...
    assurance_doctor: packageJson.scripts?.["assurance:doctor"],
  ...
  const commandPlan = [
    ...
    ["assurance:doctor", npmBin, ["run", "assurance:doctor"], { timeout: 60_000, env: { ORANGEBOX_BACKEND_PROOF_IN_PROGRESS: "1" } }],
