...
function backendPackageJson() {
  ...
  const pkg = {
    ...
    scripts: {
      ...
      "horizon:review": "node ./scripts/v4/orangebox-horizon-review-doctor.mjs --json --receipt",
      "horizon:bakeoff": "node ./scripts/v4/orangebox-horizon-promotion-bakeoff-doctor.mjs --json --receipt",
      ...
      "littleorange:doctor": "node ./scripts/v4/littleorange-doctor.mjs --json --receipt",
      ...
      "visual:artifact-vault": "node ./scripts/v4/orangebox-visual-artifact-vault-doctor.mjs --json --receipt",
      "visual:artifact-smoke": "node ./scripts/v4/orangebox-visual-artifact-smoke-doctor.mjs --json --receipt",
      "visual:runtime:headless-image": "node ./scripts/v4/orangebox-headless-image-runtime-doctor.mjs --json --receipt",
      "visual:runtime:headless-design": "node ./scripts/v4/orangebox-headless-design-runtime-doctor.mjs --json --receipt",
      "visual:runtime:headless-audio": "node ./scripts/v4/orangebox-headless-audio-runtime-doctor.mjs --json --receipt",
      "visual:runtime:headless-animation": "node ./scripts/v4/orangebox-headless-animation-runtime-doctor.mjs --json --receipt",
      "visual:readiness": "node ./scripts/v4/orangebox-visual-production-readiness-doctor.mjs --json --receipt",
